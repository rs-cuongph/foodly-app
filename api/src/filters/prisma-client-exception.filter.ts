...
export class PrismaClientExceptionFilter extends BaseExceptionFilter {
  ...
  private catchClientKnownRequestError(
    ...
    if (statusCode === HttpStatus.BAD_REQUEST) error = 'Bad Request';
    if (statusCode === HttpStatus.NOT_FOUND) error = 'Not Found';
    if (statusCode === HttpStatus.CONFLICT) error = 'Conflict';
    ...
    if (host.getType() === 'http') {
      ...
      return super.catch(
        new HttpException({ message, error, statusCode }, statusCode),
        host,
      );
      ...
      return new HttpException({ message, error, statusCode }, statusCode);
    }
  }
